...
mixin _$AuthState {
  LocalUser? get user =>
      throw _privateConstructorUsedError; // MyProfile? profile,
...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({LocalUser? user, bool isSellerMode});
...
class _$AuthStateImpl extends _AuthState {
  _$AuthStateImpl({this.user, this.isSellerMode = false}) : super._();
...
// ChangePassword? changePassword,
  ...
  @override
  String toString() {
    return 'AuthState(user: $user, isSellerMode: $isSellerMode)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, user, isSellerMode);
...
abstract class _AuthState extends AuthState {
  factory _AuthState({final LocalUser? user, final bool isSellerMode}) =
      _$AuthStateImpl;
  ...
  @override
  LocalUser? get user; // MyProfile? profile,
// List<GetOtp>? emailList,
// List<GetOtp>? phoneList,
// ChangePassword? changePassword,
  @override
